        ...
        try {
            btnpost.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String contactNumber = text1.getText().toString();
                    if (contactNumber.isEmpty() || contactNumber.length() != 10 || !contactNumber.matches("[0-9]+")) {
                        Toast.makeText(getApplicationContext(), "Enter a valid 10-digit contact number.", Toast.LENGTH_LONG).show();
